...
export const metadata: Metadata = {
  title: "Catering",
  description:
    "White Tiger Pizza & Curry catering — bring handcrafted pizzas and authentic curries to your wedding, corporate event, or private celebration.",
};
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-16 px-6 lg:grid-cols-12 lg:gap-12 lg:px-10">
        <RevealOnScroll className="lg:col-span-5" y={30}>
          ...
          <h1 className="mt-6 font-display text-5xl font-light leading-[1.1] text-ivory-100 sm:text-6xl text-balance">
            Bring White Tiger to your event.
          </h1>
          <p className="mt-6 max-w-md text-base leading-relaxed text-stone-300">
            Tell us about your event and we&rsquo;ll put together a menu and
            quote built around it. We don&rsquo;t take table reservations —
            catering is how we come to you.
          </p>
